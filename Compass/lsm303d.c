...
uint8_t LSM303D_Init(LSM303_t * device, deviceType device, sa0State sa0)
{
...
void LSM303D_WriteAccReg(uint8_t reg, uint8_t value)
{
...
uint8_t LSM303D_ReadAccReg(uint8_t reg)
{
  uint8_t value;
...
void LSM303D_WriteMagReg(uint8_t reg, uint8_t value)
{
...
uint8_t LSM303D_ReadMagReg(int32_t reg)
{
  uint8_t value;
...
void LSM303D_WriteReg(uint8_t reg, uint8_t value)
{
...
uint8_t LSM303D_ReadReg(uint32_t reg)
{
  // mag address == acc_address for LSM303D, so it doesn't really matter which one we use.
